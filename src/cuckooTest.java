...
public class cuckooTest {
	...
	for (long i = 0; i < tests; i++)
	    Sigmoid.rootSigmoid(i, 1);
	System.out.println("Square Root: " + (System.currentTimeMillis() - time) / 1000.0);

	time = System.currentTimeMillis();
	for (long i = 0; i < tests; i++)
	    Sigmoid.fastSigmoid(i, 1);
	System.out.println("Absolute Value: " + (System.currentTimeMillis() - time) / 1000.0);
