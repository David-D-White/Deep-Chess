...
public class Debug extends PApplet {
	...
	// try {
	// FileInputStream netFile = new FileInputStream("nets/NET_TOP.txt");
	...
	// t = new Trainer(100, seeder, mp);
	t = new Trainer(100);

	System.out.println("Generation: " + t.generationNum());
	long time = System.currentTimeMillis();
	t.runGeneration(4, 50, true, Runtime.getRuntime().availableProcessors());
	...
	System.out.println("Generation Relative Fitness: " + generationStats[0] + "," + generationStats[1] + "," + generationStats[2] + "," + generationStats[3]
		+ "," + generationStats[4]);
	System.out.println("---------------------------------------------");
