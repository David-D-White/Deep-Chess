...
public class TrainingGame extends Game {
	...
	/**
	 * A thread safe version of completeGame().
	 */
	...
	public double getFitness(boolean white) {
		...
		case WHITE_MATE:
		case RESIGN_BLACK:
			return white ? 2 : Math.tanh((double) pos.bMtrl / (double) pos.wMtrl);
		case BLACK_MATE:
		case RESIGN_WHITE:
			return white ? Math.tanh((double) pos.wMtrl / (double) pos.bMtrl) : 2;
		case BLACK_STALEMATE:
		case WHITE_STALEMATE:
		case DRAW_50:
		case DRAW_REP:
			return white ? Math.tanh((double) pos.wMtrl / (double) pos.bMtrl) : Math.tanh((double) pos.bMtrl / (double) pos.wMtrl);
		default:
			return 0;
		}
	}
