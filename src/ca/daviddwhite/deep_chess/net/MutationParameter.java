...
public class MutationParameter {
    ...
    /** The probability that weights will be mutated. Default 1. */
    public double weightMutateChance = 1;

    /** The probability that neurons will be mutated. Default 0.1. */
    public double neuronMutateChance = 0.1;

    /** The chance to mutate a layer. Default 0.01. */
    ...
    /** The probability that an individual neuron will be added or removed. Default 0.1. */
